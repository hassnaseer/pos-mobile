...
const FactoryOrderInboxScreen = () => (
  <View style={styles.root}>
    <Text style={styles.title}>Order Inbox</Text>
    <Text style={styles.sub}>Factory order inbox coming soon.</Text>
  </View>
);
...
export default FactoryOrderInboxScreen;
