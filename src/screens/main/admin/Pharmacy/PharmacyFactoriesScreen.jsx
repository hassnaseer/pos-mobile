...
const PharmacyFactoriesScreen = () => (
  <View style={styles.root}>
    <Text style={styles.title}>Browse Factories</Text>
    <Text style={styles.sub}>Pharmacy factory browsing coming soon.</Text>
  </View>
);
...
export default PharmacyFactoriesScreen;
